...
public class TimeDiff {
	// 1. 오늘날짜를 문자로 변경 : 날짜 형식기호에 맞도록 설계
	...
	public int timeDiff(String wCdate) {
		...
		// 1-2. DB에 저장된날짜(2021-11-23 13:04:25.5)를 앞과 같은 포멧형식으로 처리한다.
		...
		// 3. 날짜형식으로 변경된 두자료(today, dateWdate)를 숫자형식으로 변경처리한다. (시간으로 연산처리하기위함) - 결과값은 ms형식으로 반환된다
