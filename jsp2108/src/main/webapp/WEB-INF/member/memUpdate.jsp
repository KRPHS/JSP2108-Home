...
<%		} %>
    ...
    <div class="form-group"> 회원 사진 (파일 최대용량 : 2Mb) <a href="<%=request.getContextPath() %>/data/member/<%=vo.getPhoto()%>" target="_blank"><img src="<%=request.getContextPath() %>/data/member/<%=vo.getPhoto()%>" width="80px"></a>
